(function (f) { if (typeof exports === "object" && typeof module !== "undefined") { module.exports = f() } else if (typeof define === "function" && define.amd) { define([], f) } else { var g; if (typeof window !== "undefined") { g = window } else if (typeof global !== "undefined") { g = global } else if (typeof self !== "undefined") { g = self } else { g = this } g.pseudocode = f() } })(function () {
        ...
        1: [function (require, module, exports) {
            ...
            module.exports = {
                ...
                renderClass: function (class_name, options) {
                    var algorithms = document.getElementsByClassName(class_name);
                    const l = algorithms.length;
